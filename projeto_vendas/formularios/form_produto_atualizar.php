...
<div class="navbar">
	...
	<h3 id="banner">
		<fieldset>
			...
			<form method="POST" action="../controle/atualizar_produto_update.php">
				...
				try{
				  ...
				  print "<select name='nome_produto'>";
				  foreach ($conn->query($sql) as $row) {
				    print "<option value=".$row['Cod_produto'].">".$row['nome_produto']."</option>";
				  }
				  print "</select>";
				}
        ...
        <legend>Atualizar nome do produto</legend>

			<form method="POST" action="../controle/atualizar_produto_nome_update.php">
				...
				<label>Nome novo do produto:</label>
        ...
        <legend>Atualizar nome da categoria do produto</legend>

			<form method="POST" action="../controle/atualizar_produto_categoria_update.php">
				...
				<label>Nova categoria do produto:</label>
				<input type="text" value="" name="categoria_nova" required="required" /></br></br>
