...
<div class="navbar">
	...
	<h3 id="banner">
		...
		<fieldset>
			<legend>Cadastro de nova filial</legend>
			<form method="POST" action="../controle/inserir_filial_insert.php">

				<label>Bairro:</label>
				<input type="text" value="" name="bairro" required="required" /></br></br>

				<label>CNPJ:</label>
				<input type="number" value="" name="cnpj" required="required" /></br></br>
