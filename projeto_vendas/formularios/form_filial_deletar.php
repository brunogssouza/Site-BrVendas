...
<div class="navbar">
	...
	<h3 id="banner">
		<fieldset>
			<legend>Deletar filial</legend>

			<form method="POST" action="../controle/deletar_filial_delete.php">

				<label>Bairro:</label>
				<input type="text" value="" name="deletar_bairro" required="required" /></br></br>
