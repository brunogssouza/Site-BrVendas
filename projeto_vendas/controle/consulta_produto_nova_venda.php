    ...
    <h3 id="banner">
        <fieldset>
                ...
                try {
                    ...
                    print "<form method='post' action='inserir_venda_insert.php'><table>";
                    foreach ($conn->query($sql) as $row) {
                        print "<br><br>";
                        print "<tr><td><input name='produto_escolhido' type='radio' value='".$row['Cod_produto']."'>".$row['nome_produto']."</td></tr>";
                    }
                    print "</table><input type='submit' value='Incluir produto'></form>";
