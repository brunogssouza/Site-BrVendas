...
<div class="navbar">
    ...
    <h3 id="banner">
        <fieldset>
                ...
                include("conexao.php");
                try{
                    $produto=$_POST['produto_escolhido'];
                    $sql = "SELECT num_pagamento FROM pagamento ORDER BY num_pagamento DESC LIMIT 1";
                    foreach($conn->query($sql) as $row){
                        $cod_pagamento = $row['num_pagamento'];
                    }
                    $sql="INSERT INTO venda(Informações_Pagamento, Informações_Produtos) VALUES ('$cod_pagamento','$produto')";
                    $conn->query($sql);
                    echo "Cadastro de compra realizado com sucesso";
                    echo "<br><br>";
                    echo"<a href='consulta_produto_nova_venda.php'>Retornar a seleção de produtos</a>";
