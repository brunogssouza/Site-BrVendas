...
<div class="navbar">
	...
	<h3 id="banner">
        ...
        <fieldset>
			...
			<br>
			<legend>Atualizar cadastro de nome da filial:</legend>

            <?php
                    include("conexao.php");
                    try {

                        $fil_att = $_POST['filial_nova'];
                        $fil_antigo = $_POST['filiais'];
                    
                        $sql = "UPDATE filiais SET nome_bairro = '$fil_att' WHERE num_filial = $fil_antigo";
                        $conn->query($sql);
                    ...
                    echo "<br><br>";
                    echo "Alteração para '$fil_att' realizado com sucesso!";
                    print "<br><br>";
