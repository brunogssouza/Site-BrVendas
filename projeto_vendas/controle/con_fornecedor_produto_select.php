...
<div class="navbar">
	...
	<div id="cabecalho">
		<h1>Consulta de fornecedora de produtos</h1>
	</div>

	<h3 id="banner">
		<fieldset>
			<legend>Consulta de fornecedor</legend>
                ...
                try {
                    $sql= 'SELECT  nome_Fornecedor, nome_representante  FROM fornecedor_produto';
                    foreach ($conn->query($sql) as $row) {
                        print "<br><br>";
                        print $row ['nome_Fornecedor']. "<br> ";
                        print $row ['nome_representante']. "<br>";
                    }
