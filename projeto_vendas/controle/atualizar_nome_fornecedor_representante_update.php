...
<div class="navbar">
	...
	<h3 id="banner">
        ...
        <fieldset>
			...
			<br>
			<legend>Atualizar nome do representante:</legend>

            <?php
                    include("conexao.php");
                    try {

                        $rep_att = $_POST['representante_nova'];
                        $rep_antigo = $_POST['nome_rep_antigo'];
                    
                        $sql = "UPDATE fornecedor_produto SET nome_representante = '$rep_att' WHERE num_Fornecedor = $rep_antigo";
                        $conn->query($sql);
                    ...
                    echo "<br><br>";
                    echo "Alteração para '$rep_att' realizado com sucesso!";
                    print "<br><br>";
