...
<div class="navbar">
	...
	<h3 id="banner">
        ...
        <fieldset>
			...
			<br>
			<legend>Atualizar especificações da categoria:</legend>

            <?php
                    include("conexao.php");
                    try {

                        $cat_prod = $_POST['categoria_produto'];
                        $cat_novo = $_POST['categoria_nova'];
                                
                        $sql = "UPDATE categoria_produtos SET CATEGORIA = '$cat_novo' WHERE NUM_CATEGORIA = $cat_prod";
                        $conn->query($sql);
                    ...
                    echo "<br><br>";
                    echo "Alteração das especificações do produto realizado com sucesso!";
                    print "<br><br>";
