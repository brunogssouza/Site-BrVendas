...
<div class="navbar">
	...
	<h3 id="banner">
        ...
        <fieldset>
			...
			<br>
			<legend>Atualizar CPF do cliente:</legend>

            <?php
                    include("conexao.php");
                    try {

                        $cpf_att = $_POST['cpf_novo'];
                        $cpf_antigo = $_POST['cpf_antigo'];
                    
                        $sql = "UPDATE cliente SET CPF = '$cpf_att' WHERE CPF = '$cpf_antigo'";
                        $conn->query($sql);
                    ...
                    echo "<br><br>";
                    echo "Alteração para '$cpf_att' realizado com sucesso!";
                    print "<br><br>";
